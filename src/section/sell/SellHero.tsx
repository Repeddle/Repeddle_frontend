    ...
    <section className="flex flex-col items-center mx-0 lg:my-10 my-5">
      ...
      <div className="relative w-full lg:h-[70vh] h-auto">
        <img
          ...
          alt="main Image"
        />
        <h1 className="font-bold text-shadow absolute max-w-[300px] text-3xl text-center top-[80%] lg:text-start lg:text-[80px] text-white-color -translate-y-2/4 left-[10%] lg:top-2/4">
