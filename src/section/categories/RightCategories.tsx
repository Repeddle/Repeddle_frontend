...
const RightCategories = ({ categories, deleteHandler, handleEdit }: Props) => {
  return (
    <div className="flex-1 p-5 rounded-[0.2rem] bg-light-ev1 dark:bg-dark-ev1">
      <div className="flex flex-col mr-5 mt-2.5 mb-2.5 p-2.5 rounded-[0.2rem] bg-light-ev2 dark:bg-dark-ev2">
        <label className="text-sm font-semibold">Categories List</label>
      </div>
