...
export const likeProductCommentService = async (commentId: string) => {
  try {
...
export const unlikeProductCommentService = async (commentId: string) => {
  try {
    const data: { message: string; comment: IComment } = await api.post(
...
export const deleteProductCommentService = async (commentId: string) => {
  try {
    const data: { message: string } = await api.delete(
      `/comments/${commentId}`
    );
    ...
    // Handle network errors or other exceptions
    // You can log the error or perform other error-handling actions
    console.error("delete coment error:", getBackendErrorMessage(error));
...
export const likeProductCommentReplyService = async (replyId: string) => {
  try {
...
export const unlikeProductCommentReplyService = async (replyId: string) => {
  try {
    const data: { message: string; reply: ICommentReply } = await api.post(
...
export const deleteProductCommentReplyService = async (replyId: string) => {
  try {
    const data: { message: string; reply: ICommentReply } = await api.delete(
      `/replies/${replyId}`
    );
