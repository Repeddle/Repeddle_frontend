...
const Form: React.FC<FormProps> = ({ setScreen, loginGuest }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-full overflow-y-auto text-black ">
      <div className="w-3/4 mt-8">
        <div className="mb-4">
          <input
            name="fullName"
            type="text"
            className="block w-full border p-2 rounded-md focus:border-orange-color focus:outline-none "
