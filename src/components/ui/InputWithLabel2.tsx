    ...
    <div className="flex flex-col w-full gap-2">
      ...
      <div className="w-full relative">
        <input
          ...
          id={id}
          name={name}
          className="border w-full h-10 bg-transparent px-4 py-2.5 rounded-[0.2rem] focus-visible:outline focus-visible:outline-orange-color border-light-ev4 dark:border-dark-ev4 text-black dark:text-white"
