  ...
  return (
    <div className="snap-start h-60 relative mr-[15px]">
      <div className="h-60 relative w-60 rounded-[5px] bg-white">
        ...
        />
        <Link to={link}>
          <p className="border bg-white hover:bg-malon-color hover:text-white border-malon-color text-malon-color cursor-pointer flex justify-center absolute capitalize w-[170px] rounded-[5px]  right-0 bottom-0">
            {title}
          </p>
        </Link>
      </div>
