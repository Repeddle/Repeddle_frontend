...
function ContactUs() {
  return (
    <div className="container mx-auto max-w-7xl w-full flex-col lg:flex-row mt-5 lg:mt-14 flex p-8 lg:rounded-xl mb-10">
       <div className="lg:w-1/2 w-full p-5 rounded-lg mb-4 lg:mb-0" >
        <div className="w-full">
        <h3 className="text-lg lg:text-2xl lg:mt-4 font-medium mb-4" >Contact Us</h3>
       <h2 className="text-2xl lg:text-4xl lg:mt-12 font-medium">Get In Touch With Us</h2>
       <p className="text-base text-justify lg:mr-20 mt-7 lg:mt-3">
       ...
       Whether you're looking for unique items, seeking advice on products, or have questions about our services ❓, we're ready to assist 🤝.
       </p>
      ...
      <div className='lg:w-1/2 w-full p-4 bg-malon-color rounded-lg'>
      <form className="space-y-6 mt-5 w-full text-white">
        <div>
        ...
        <div>
          ...
          >
            ...
            <option value="Suggestions" className="text-black ">Suggestions</option>
        ...
        <div className="flex justify-center items-center w-full">
          <button
            type="submit"
            className="block justify-center align-middle items-center w-full px-4 py-3 mt-4 font-medium text-white bg-orange-400 border-2 
            rounded-md hover:bg-black focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 mb-10 shadow-2xl" 
            style={{
              boxShadow:
                "0 4px 6px rgba(0, 0, 0, 0.3), -4px 0 6px rgba(0, 0, 0, 0.3), 4px 0 6px rgba(0, 0, 0, 0.3)",
            }}
          >
            Submit
          </button>
