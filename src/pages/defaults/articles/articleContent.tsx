    ...
    <div className="container mx-auto p-4 max-w-5xl text-justify">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
        <div className='mb-4 lg:mb-0 text-left lg:text-left'>
          ...
          <Link to="/articles" className="text-orange-300">Articles</Link> / 
          <span>Seller</span>
        </div>
        <div className="relative w-full lg:w-auto">
          <FaSearch className="absolute top-2 left-2 text-gray-500 mt-1 ml-1 cursor-pointer" />
          <input type="text" placeholder="Search articles..." className="pl-8 pr-2 w-full lg:w-80 h-10 border
      ...
      {article && (
        <div className='lg:mt-12'>
          <h1 className="text-3xl font-bold mb-4 text-center">{article.topic}</h1>
          <div
