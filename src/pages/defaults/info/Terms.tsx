    ...
    <div className="container mx-auto max-w-7xl px-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-justify mt-5">
          ...
          hyperlink. These Terms of Use apply to all users of The Service,
          including without limitation users who are Browsers, Influencers,
          Buyers, Sellers, Affiliates, Third parties and/or Contributors of
          content.
        </p>
        <p className="text-justify mt-5">
          Please read these Terms of Use carefully before accessing or using our
          website. By accessing or using any part of the service, App and
          Website, you agree to be bound by these Terms of Use. If you do not
          agree to all and any of the terms and conditions of this agreement,
          then you may not access the website or use any services. If these
          Terms of Use are considered an offer, acceptance is expressly limited
        ...
        <p className="text-justify mt-5">
          ...
          notification. It is your responsibility to check this page
          periodically for changes. Your continued use of or access to the App
          and Website “The Service” following the posting of any changes
      ...
      <section className="mb-8">
        ...
        <p className="text-justify mt-5">
          By agreeing to these Terms of Use and use of this service, you
          represent that you are at least the legal age “16” (sixteen), or the
          age of majority in your country, state or province of residence. If
          you are a minor or not legally obligated to undertake legal agreement,
          you may then use this service with only the overseeing of your parent
          or legal guardian. With this consent, such a person agrees to be
          liable and responsible for you, then you and your overseer is bound by
          this Terms and Conditions throughout the Repeddle Platform.
        </p>
        <p className="text-justify mt-5">
          ...
          any laws of the country or laws in your jurisdiction (including but
          not limited to copyright laws). In line with the terms of copyright
          laws and regulations, the content and information herein (includes but
          not limited to; Images, videos, materials, data, trade secret, logos,
          software, icons, text, sound clips, graphics, trade names, lay-outs,
          advertisements, trademarks, designs, brands and intellectual
          properties) contain on our App and Website are properties of
          Repeddle’s brand or its third party and therefor protected by
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          account, known as (User Account) as it applies respectively. Guest
          users only have access to some functionality of the App and Website,
          registered users have access to all functionalities available to all
          users. To create account, you will need to register with your
          credential “Name, Email, Phone Number” or either a G-mail or Facebook.
          You may follow the direction on our website on how to create account,
          place order or make changes to already placed order before submission.
          As a seller, you may carefully follow the step-by-step guidelines on
          our (Seller’s Guideline) to create and personalize your store. The
          user is solely responsible for all activities that take place on the
          registered profile or signed in account. Repeddle is not liable for
          any access into your profile, ensure not to disclose your login
        ...
        <p className="text-justify mt-5">
          ...
          ‘User’ to any party. Each user must have their own exclusive account
          and store profile with its own unique username, email, information and
          storefront of sell (S.O.S). For any reason, should there be need for
          you to transfer your account, you must do so with a prior written
          consent of Repeddle with a permissible reason why you need your
          account transferred, and shall only proceed to do so with Repeddle’s
          support written approval. You agree that you are wholly accountable
          for activity that takes place in your account and in the event the
          above mention is not adhered to, will be deem bridge of contract and
          may lead to temporary account suspension, termination of use of the
          Services, and or deactivation.
        </p>
        <p className="text-justify mt-5">
          You agree that; (i) A successful registered user account is capable of
          fulfilling its obligation and rendering the services herein on
          Repeddle App and Website. (ii) A suspended Person wishing to register
          to be a user must make an application to Repeddle. The decision of
          Repeddle official representative in this regard is final and no
          further correspondence shall be entered into with unsuccessful
          applicants. (iii) If the User is a juristic person, any natural person
          who logs into the Account for the first time warrants that he/she has
          the authority to bind the user to this Agreement. As part of the
          application, in order to comply with the Electronic Communications and
          Transactions Act 2002 (“ECTA”), you must provide us with your legal
          name, if you are a juristic person (or your real name, if you are a
          natural person), your trading name, registration number (or identity
          number), main business, physical address for legal purposes, office
          bearers official phone number and e-mail address. You must also
          provide all other documentation and information reasonably requested
          by Repeddle for vetting purposes. You hereby authorize us to verify
          all information that you provide to us, and you undertake by entering
          into this Service, you have provided confirmation to such
          authorization for the verification to be carried out by Repeddle
          (where the need arises).
        </p>
        <p className="text-justify mt-5">
          By registering for or using the Services, you authorize Repeddle to
          perform the Services as set out herein which may include and not
          limited to; Repeddle acting as a third party ‘your agent’ who market
          and provide you the service, use all information including user’s
          name, Product name, Visuals, Logos, Banners, Listing, Trademarks
          provided on our App and website or your social media handles. That you
          expressly grant us intellectual property rights, and or outstanding
          indications by various method and formats for marketing and sells
          purposes which users may also have access to.
        </p>
        <p className="text-justify mt-5">
          ...
          (including your password) to your user account on the Profile. You
          shall be responsible for, and be bound by, any activity on your
          Repeddle’s Account (whether authorized by you or not) which is done
          using your login credentials.
        </p>
        <p className="text-justify mt-5">
          The trading name of your Repeddle’s Account (“User Name”): (i) Must
          accurately reflect the identity of the User; (ii) Must not infringe
          any trademark or intellectual property rights of any third parties,
          ...
          Etc.); and/or (iv) Cannot be similar to any trademark owned by
          Repeddle. Repeddle may, in its sole discretion, terminate or suspend
          any Service, or this Agreement as a whole, immediately with or without
          written notice to the User for any non- compliance with this clause.
          (v) In the event user infringes any third party right in any form
          whatsoever, Users agrees to completely indemnify Repeddle against any
          claim occurring from such infringement.
        </p>
        <p className="text-justify mt-5">
          Where you register multiple Accounts on Repeddle (whether or not under
          different trading names) for the same user (whether a juristic person
          or natural person), such accounts shall be treated as one Repeddle
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          we offer on our App and Website, however, we reserve the right to
          refuse service to anyone for any reason or no reason at any time.
          Repeddle may provide You, or provide Your Content to, certain third
          party services or third party service providers (collectively, "Third
          Party Service(s)") which may also provide You links to sites, email
          and telephone correspondence and other offers outside of Repeddle,
          such Third Party Services are provided "AS IS" or “AS AVAILABLE”
          ...
          Services. You are responsible for evaluating whether You want to
          access or use such Third Party Services, and, in certain circumstances
          where required or applicable, may opt-out from such Third Party
          Services available outside of Repedddle, or may choose to not utilize
          such Third Party Services at any time. We reserve the right to suspend
          Third Party Services at any time.
        </p>
        <p className="text-justify mt-5">
          You should review any applicable terms and/or privacy policies of a
          Third Party Service before using it or sharing any information with
          it, because You may give the operator permission to use Your
          information outside of what You have agreed to herein. Repeddle is not
          responsible for, nor endorses any features, content, advertising,
          products or other materials on or available from Third Party Services.
          You agree not to reproduce, duplicate, copy, sell, resell or exploit
          any portion of the Service, use of the Service, or access to the
          Service or any contact on the App and Website through which the
          service is provided, without express written permission by Repeddle.
        </p>
        <p className="text-justify mt-5">
          ...
          Credit/debit card information are always encrypted during transfer
          over networks. Repeddle will not be liable in any way for (1) any
          article or content on the Service posted by third parties, other
          users, or at the direction of users (all, “Third Party Materials”), or
          (2) Any errors, omissions, loss, or damage of any kind as a result of
          such Third Party Materials on the Service; and you acknowledge that
          Repeddle does not, and is under no obligation, to review, screen, or
          inspect any Third Party Materials on the Service, however, Repeddle
          reserves the right to do so, and remove Third Party Materials at Our
          sole discretion. You agree that you bear all risk associated with the
          use, reliance, condition, accuracy, competence, completeness, or
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          that are not affiliated with Repeddle, your use of such links are
          solely at your own risk.
        </p>
        <p className="text-justify mt-5">
          We shall not be held responsible for any direct or indirect loss,
          claims or expense that may arise thereof. Furthermore, we are not
          responsible for examining or evaluating the content or accuracy of
          those website, and we do not warrant and will not have any liability
          or responsibility for any third-party materials or websites, or for
        ...
        <p className="text-justify mt-5">
          ...
          be directed to the third-party. The headings used in this agreement
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          available on this site is not accurate, complete or current. As Users
          of Our Services, all information, including items, messages, offers,
          ...
          submitting any Content to us, you hereby expressly represent and
          warrant that You own all rights to the Content or, alternatively, that
          You have the right to give us the license described below, including
          the correct and legal permissions and consents for any personally
          identifiable information you may provide to, or upload by way of,
          Repeddle Service(s).
        </p>
        <p className="text-justify mt-5">
          By posting or otherwise transmitting any User Content, you hereby
          grant and will grant Repeddle and its affiliated companies a
          nonexclusive, worldwide, royalty free, fully paid up, transferable,
          sub-licensable, perpetual, irrevocable license to copy, display,
          transmit, perform, distribute, store, modify, make derivative works of
          and otherwise use in any manner your User Content in connection with
          the operation of the Service or any other products or services of
          ...
          rights, privacy rights, publicity rights, or other legal rights of any
          third party.
        </p>
        <p className="text-justify mt-5">
          ...
          this site is at your own risk. We are not under any obligation to
          review any Content posted by Our Users on Our Services, although We
          reserve the right to do so with or without notice, to prevent or
          rectify any alleged violations of this Agreement or any applicable
          law. We reserve all defenses made available to us by the
          Communications Act and any other applicable laws, rules, or
          regulations. We may refuse to accept or display the Content, and may
          remove or delete all or any portion of the Content at any time.
        </p>
        <p className="text-justify mt-5">
          This site may contain certain historical information and historical
          information necessarily is not current and is provided for your
          reference only. You understand that Repeddle is not responsible for
          the accuracy, usefulness, safety, or intellectual property rights of
          or relating to such and any Content, and that such Content is not the
          responsibility of Repeddle. We reserve the right to modify the
          contents of this site at any time, but we have no obligation to update
          any information on our site. You agree that it is your full
          responsibility to monitor changes to our site. You further understand
          ...
          may have against the Repeddle Parties with respect thereto.
        </p>
        <p className="text-justify mt-5">
          ...
          understand is intended to be shared with other users of our Services
          as well as third parties, all in Repeddle’s sole discretion, and
          Repeddle has no control or liability over what other users do with
          your Content. You understand and agree that Repeddle will not be
          liable for any treatment of your Content as confidential and waive all
          rights with respect to any such claims of confidentiality. You
          ...
          (“Submissions”), provided by you to Repeddle are non-confidential and
          Repeddle shall be entitled to the unrestricted use and dissemination
          of these Submissions for any purpose, commercial or otherwise, without
          acknowledgment or compensation to you. If you do not agree that your
          Content will be considered public and will not be considered
          confidential, you are oblige not to use the Service. Your Obligation:
          You are solely obligated for any and all information, descriptions,
          pictures, listings, data, text, music, videos, media, comments, or any
          other materials (“Content”) that you upload, post, publish, transmit,
          or display (“Post”) via the Service. Below mentions are examples of
          Content, Postings, or Use of the Service that is illegal or prohibited
          by Repeddle.
        </p>
        <p className="text-justify mt-5">
          You agree not to use the service to (1) provide any Content, Postings,
          or otherwise that are unlawful, harmful, violent illegal, infringing
          on third party rights, objectionable, pornographic, libelous,
          invasive, encouraging money laundering, gambling or any other unlawful
          or unwarranted behavior. (2) violate any law, rule, or regulation,
          including any anti-spam, data privacy, or other restriction that may
          be applicable to Your use of the Service (3) create any derivative
          works or reviser engineer any part of the Service, or put unreasonable
          load on the Service infrastructure or disrupts the networks connected
          to the Service (4) promote any illegal activity or enterprise (5)
          stalk, harass, bully, impersonate or solicit information from anyone,
          especially those that are under the age of legally permissible, in
          this case Fifteen(15), copy, scrape, harvest or use automated systems
          to collect contact information from the Service for use outside of
          those intended by this Terms of Use (7) sell or transmit anything you
          don’t have a right to sell or transmit under law or existing
          relationship (8) pose a privacy or security risk (9) infringe on
          anyone’s intellectual property (10) spam any users with email, junk
          mail, fraud, schemes, or the like (11) transmit or upload viruses,
          worms, or interfere with the Service, or (12) take any action or
          inaction which Repeddle, in its sole judgement, believes is
          questionable or could cause harm or liability. Repeddle in all it
          right may investigate, take legal action, or perform any other action
          it deems necessary or warranted in managing the Service, Your Content,
          Posting, or Use, without limitation, including preservation of such
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          By Using Our Service, you agree that you may receive communications
          from Repeddle, including, but not limited to, newsletters, promotions,
          special offers, account reminders and updates. When you use our
          Services or send emails, text messages, and other communications from
          your any of your device to us, you are engaging in electronic
          communications with us. You consent to receive communications from us
          electronically, as thus emails, texts, mobile push notifications, or
          notices and messages from our site or through other Services provided
          on our Site, and you are allowed to retain copies of these
          communications for your records. You agree that all agreements,
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          Applicable), hence, you may be advised not to make final decision
          based on the product price seen or heard except if otherwise stated on
          our site, the total cost of your order is usually displayed during
          checkout, displayed product prices are reflected in your home
          currency, however, the total payable charges of ordered goods may be
          subject to change depending on third-party payment gateway exchange
          rate of your country’s current currency.
        </p>
        <p className="text-justify mt-5">
          ...
          change, suspension or discontinuance of the Service. Repeddle may
          offer promo or credits to existing users at intervals, for any reason,
          at the sole discretion of Repeddle, including, but not limited to,
          users who refer new users to the Service (who have not previously used
          the Service) using the invite code provided by Repeddle to those
          existing users and may also make certain credits available to the new
          users who are referred by an existing user. This promotion may be
          subjected to some selected goods, products or brands with certain
          terms and conditions. The requirements to earn, the number of, and
          value of, these credits (if any) will be determined by Repeddle.
          Repeddle Credits are not redeemable for cash or cash equivalents, and
          are non-transferrable or applicable to prior purchases and cannot be
          sold, made available to the general public, or acquired via public
          distribution.
        </p>
        <p className="text-justify mt-5">
          ...
          restrictions may apply. You accept that we may choose to cancel
          credits or any sort of coupon, promo and offers at any time, or upon
          fourteen (14) day notice to You at our sole discretion. On checkouts,
          you may be required to apply a given coupon, referral or promo code.
          In some instance, it may apply automatically and you will be notified
          by price change on checkout. Repeddle may modify, update, or terminate
          this program without notice, and Repeddle reserves the right to enact
          any rules and regulations with respect to the program, including
          value, earning and use limits, as well as invalidation or expiration
          of credits. You may apply credits subject to the terms in which we
          grant the credit. Credits may expire prior to your use, cancelled at
          any time. Understand that we reserve the right to withdraw from any
          promotion or similar incentives of any sort on our website without
          prior notice and claims may not be hold against us for any withdrawal
          herein.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          that are third party’s contents that is protected by trademark,
          patent, copyright, trade secret and other proprietary rights and laws
          referred to as “Content”. All rights to Repeddle’s intellectual
          properties are solely reserve to Repeddle. No modification,
          distribution, copying, recreate, derivate, record, store of any
          content related to Repeddle service is permissible. Involving in any
          act mentioned above is regarded by Repeddle as breach of intellectual
          property right.
        </p>
        <p className="text-justify mt-5">
          ...
          unacceptable, hence deem to be intellectual property, any proceed
          yield from the use of Repeddle’s intellectual property, trademark or
          content shall be independently of Repeddle’s advantage. All third
          party products, service, logos and brand names appearing on our
          Websites or any of our Platforms are independent trademarks of their
          respective owners. Except otherwise mentioned, Repeddle has no
          affiliation, connection, endorsement or endorses any trademark
          displayed on it online or physical platforms.
        </p>
        <p className="text-justify mt-5">
          Repeddle respects the intellectual property of others. Should you
          believe, in good faith, that any materials on the Services infringe
          upon your copyrights, you may submit a Copyrights Infringement notice
        ...
        <p className="text-justify mt-5">
          ...
          owner of the copyright interest; <br />
        ...
        <div className="text-justify -mt-5">
          <ol className="mb-4 mt-4 pl-6 list-decimal list-inside">
            <li>
              ...
              faith and transparency, Users warrants that they are original
              owner and or beneficiary to the work they post on Repeddle, or
              have legal right and binding to the title or a trademark.
            </li>
            <li>
              ...
              legal capacity to enter and honor its responsibility and
              obligations in regard to the services provided and operates an
            ...
            <li>
              ...
              expressly indemnify Repeddle against such actions and Repeddle
              will not be liable of any cost.
            </li>
            <li>
              Users warrants that to her best knowledge, is unaware of any
              breach of contract, claim or penalty for infringement of
              copyright, trademark law or intellectual property against them
              ensue out of production, designing or manufacturing of products as
              at when entering to this agreement, and agrees to inform Repeddle
              with immediate effect should such claim ensue.
            </li>
            <li>
              Seller agrees that in no circumstances will the listing, selling
              and shipping her product to our customers through our platform
              will infringe any rights or third parties’ intellectual properties
            ...
            <li>
              ...
              their account, products, designs, production, and listings are
              true, correct and updated to the best of their knowledge, that the
              product they sell on our platform will be of standard good quality
              and useable. Seller accepts that their production, material,
              fabrics, designs, are authentic and free from defect. With the
              continual use of Repeddle’s platform, Seller agrees that this
              agreement remains valid and they are legally bind by this
              agreements and other policies and guideline herein.
            </li>
          </ol>
        </div>
      </section>
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          through the App and Website. These products or services may have
          limited quantities and are subject to return only according to our
          Return Policy. As a seller, you agree you have made every effort to
          display accurately the colors, description and images of our products
          that appear in your store. For all Users, we cannot guarantee that
          your computer monitor's display of any color will be accurate. We
          ...
          right to limit the quantities of any products or services that is
          offered. All descriptions of products or product pricing are subject
          to change at any time without notice, at the sole discretion of the
          seller or us. We reserve the right to discontinue any product at any
          ...
          will meet all your expectations, or that any errors in the Service
          will be corrected.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          We make cautious effort to protect the interest of Repeddle users.
          Using Repeddle Buyer’s and Seller’s protections, we try to eliminate
          ...
          including full payments of your purchase must be made within
          Repeddle’s App and Website. Buyers must use only the payment methods
          and methods of delivery provided in line with our Terms of Use. Buyers
          can only pay for their purchase with the available payment methods
          offered on Repeddle’s App and Website checkout. The Repeddle
          protections for both Buyers and Sellers against potential fraud works
          as follows:
        </p>
        <div className="text-justify mt-2">
          <ol className="mb-4 mt-3 pl-6 list-decimal list-inside">
            <li>
              ...
              communications seamless between Sellers and Buyers. We advise
              Buyers and Sellers to communicate regarding product information to
              ensure Buyers get all necessary information that will help them
              make an informed purchase decision before buying. This will help
              eradicate or minimize disputes between Sellers and Buyers.
            </li>
            <li>
              After a complete order is made and payment is successful through
              checkout, the amount paid for the product is deposited in
              Repeddle’s account. The Seller will package and ship the product
              and confirms the delivery of the goods by triggering delivered
              button after completing the shipping process on the order.
            </li>
            <li>
            ...
            <li>
              ...
              the order, they will trigger the received button on the
              appropriate order. Repeddle will less its commission and remit the
              purchased order balance to the seller’s Repeddle wallet. With this
              process, Buyers get what they paid for and Sellers gets the
              payment for their sold goods. NOTE: Transaction taken outside
              Repeddle’s App and Website is not in any way protected.
            </li>
          </ol>
        </div>
      </section>
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          payment method which may include credit card and Repeddle wallet.
          Buyers may pay for products using approved payment methods, and
          Repeddle will receive payment from Buyer on Seller’s behalf. You are
          responsible for paying all fees and taxes (if applicable) associated
          with your purchase or service used when using the Services. You
          warrant that you are eligible, authorized and your credit card has
          sufficient funds to pay for the goods ordered, and that incurred
          service charges resulting to the use of Our Service can fully be paid
          for. You agree to provide current, complete and accurate purchase and
          account information for all purchases made. You agree to promptly
          ...
          complete your transactions and contact you as needed. We will not be
          hold accountable or responsible for any declined order or loss of
          goods as part of your negligence or inadequate supply of correct
          information. By submitting payment information to Repeddle, you
          authorize Repeddle’s payment service third party to store that
          information and with you confirmation, charge you for any purchased
          product or services. By using a third party payment service offered by
          Repeddle, including but not limited to PayPal, you are subject to
          their terms of use and privacy policies. For more about optional
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          Repeddle does not charge any fees for you to sign-up as a seller or
          for listing your products to sell, but shall collect commission from
        ...
        <p className="text-justify mt-5">
          ...
          fees for the Service, and such changes will be effective upon Our
          revision of the fees/commission structure. Payments will be processed
          by a third-party payment provider, and in accordance with their terms
          of service, and not by us. In other to fulfill our obligation to you
          Seller and Buyer, we reserve the right to add or change payment
          providers should the need arises. We may or not notify you of any new
          payment provider in which case, your continued use of the Service, and
          upon receipt of such notice constitutes acceptance of such addition or
          change as well as your acceptance of their fees and terms of use. You
          acknowledge that we may share the information you provided during sign
          up to our platform with any payment providers we select, solely for
          the purpose of enabling them to provide us with payment processing
          services to support the Seller and Buyer features you use.
        </p>
        <p className="text-justify mt-5">
          ...
          Taxes liability for products sold solely lies with the seller.
          Repeddle will not be liable for any issues relating to your tax
          obligation that might ensue.
        </p>
        <p className="text-justify mt-5">
          ...
          taxes and informs us, we will immediately notify you of this
          development and you are oblige to immediately fulfill your Tax
          obligation. Should you refuse to do so, according to the applicable
          law in your jurisdiction, we may suspend your account until you honor
          your tax obligation. Please note, your earnings are based on the
          listing price and actual earnings will vary based on the final order
          price, seller discounts, and any other applicable taxes and discounts
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          Buyers are responsible for shipping costs incurred in respect with
          their purchase except otherwise, where free delivery may be offered by
          ...
          applicable order during checkout (if available from delivery partner),
          you agree that the delivery times are estimated as we do not guarantee
        ...
        <p className="text-justify mt-5">
          ...
          address or pick/drop off point respectively during checkout and we do
          not deliver to PO Box. Please be sure to look out for delivery
          details, “guidelines and policy” of our delivery partner for more
          information on how their delivery system works.
        </p>
        <p className="text-justify mt-5">
          You agree to take full responsibility of any Taxes that may apply for
          your product sold with the relevant government bodies of your country.
        ...
        <p className="text-justify mt-5">
          ...
          understand that we shall not be held responsible for any charges,
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          Depending on locations, Repeddle delivery partner(s) aim to deliver
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          You may return a product after delivery, however, Repeddle allows you
          to return a product in limited circumstances. If the product you
          receive is not as described at the time of purchase, then you may log
          a return by using the “LOG A RETURN” tab on your order reporting the
          issue through the App or Website, in each case within three days after
          delivery (as determined by the tracking information and delivery) of
          the product. For more detail about returns after delivery, please
          refer to our Return and Refund Policy. By Reference, our Return and
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          new services and/or features through the App and Website including but
          not limited to, the release of new tools and resources. Such new
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          medium any comments, feedback, contents or other submissions you
          ...
          to pay compensation for any feedback, comments or other submissions;
          (3) to respond to any feedback, comments or other submissions; (4) You
          agree that you may receive telephonic, emails or electronic
          communications from us, affiliate or our third party when you visit
          our website or we receive emails, SMS or telephonic communication from
          you in regulation with our privacy policy. We may, but have no
          immediate obligation to, monitor, edit or remove comments from our App
          or Websites that may be triggering to Users or may be considered
          unlawful, offensive, threatening, libelous, defamatory, pornographic,
          obscene or otherwise objectionable or violates any parts of
          intellectual property. You also agree that your comments will not
          violate any right of any direct user, third-party, including
          ...
          contain libelous or otherwise unlawful, abusive bulling or obscene
          material, or contain any computer virus or other malware that could in
          any way affect the operation of the Service or any related App and
          Website. You will not use a false e‑mail address, pretend/impersonate
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          governed by our Privacy Policy. Please view our Privacy Policy as it
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          take all rational measures to carefully reflect these information(s),
          to avoid inaccuracies or omissions that may relate to product
          descriptions, pricing, promotions, coupons, vouchers, offers, referral
          bonuses, product shipping charges, transit times and availability. We
          ...
          information in the Service or on any related App and Website is
          ...
          clarify information in the Service or on any related App and Website,
          including without limitation, pricing information, except as required
          by law. No specified update or refresh date applied in the Service or
          on any related website should be taken to indicate that all
          information in the Service or on any related website has been modified
          or updated.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          access to any portion of the Services; <br />
          ...
          other website for any purpose; <br />
          ...
          the Website or Services, or any part thereof; <br />
          ...
          “Communications and Other Content”; <br />
          (s) Adapt, modify and/or make any derivative modifications to the
          Website or the Information, or any part thereof; <br />
          ...
          entity, vendor and/or merchant; <br />
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          any damage or loss that may arise as the breach of this Terms of Use.
          In our sole discretion, we may update these list from time to time,
          please ensure to always check the list of prohibited product for any
          new updates.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        ...
        <p className="text-justify mt-4">
          ...
          conditions of Seller ability, Sellable quality, fitness for a
          particular purpose, durability, title, and non-infringement. Repeddle
          is not liable for (i) any negative or critical comments that may be
          posted by other Users through the Services or any content posted on
          our service; (ii) purchases, sales, or other obligations that may
          arise between Users and any cost of substitute service or goods; (iii)
          any third party personally identifiable information you upload or
          provide to us pursuant to the Services or any damages that result
          through Your use of Our Services; (iv) any of the Third Party
          Service(s) You may be provided pursuant to Your use of the Services.
          You are fully aware that you are solely responsible for your
          interactions with other users, including any purchase or sale
          transactions, and you agree Repeddle will not be liable or responsible
          with respect to such purchases, interactions, or sales. We reserve the
          right but not obligated to become involved in any dispute between
          users.
        </p>
        <p className="text-justify mt-4">
          ...
          service providers or licensors shall not be liable for any injury,
          ...
          if advised of their possibility not for more than the greater amount
          of commissions that you have paid to Repeddle as a seller in the last
          six (6) months. Because some states or jurisdictions do not allow the
          ...
          shall be limited to the maximum extent permitted by applicable laws.
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          You expressly agree to indemnify, defend and hold harmless Repeddle
          ...
          claim or demand, including reasonable attorneys’ fees arises from your
          action or inactions, made by any third-party due to or arising out of
        ...
        <p className="text-justify mt-4">
          ...
          as a result of Seller liabilities, and shall not be liable for any
          fee, legal or otherwise prior to implementing right of indemnity
          against a User, and Users has agreed to indemnify Repeddle in any, and
          all area of User’s faults. The indemnities provided herein shall
          survive the termination of this agreement. Repeddle shall not be
          liable for any cost, penalty, judgement, liabilities, proceedings,
          expenses, claims, court fee/tariff or damage whatsoever to the most
          reasonably beneficial to Repeddle ensued in any form as a result of
          Users behavior (act, error or omission) while running an account or
          transacting on Repeddle’s platform, this includes but not limited to
          Seller partners, representative, contractor/subcontractor or
          employees, be it in form of misconduct, misdeed wrongdoing,
          illegality, lawlessness, or otherwise.
        </p>
        <p className="text-justify mt-4">
          Users agree to indemnify Repeddle in this agreement for all mentioned
          in this section and for any loss ensued from recklessness or otherwise
          in the form of loss of property, any loss of life, damages, personal
          injury, warrant and breach of any representation or laws. You assume
          certain risks in using a marketplace service such as Repeddle.
          Repeddle is not involved with, nor provides a warranty for, any
          transaction between Buyer and Seller, nor has title to any Items, and
          may not be the Buyer or Seller in any transaction. You as a Buyer
          and/or Seller assume, agreement, and understand You bear all of the
          risks in selling or purchasing of items on the Service.
        </p>
        <p className="text-justify mt-4">
          To allow the effect of indemnification in this Agreement and Terms,
          Repeddle shall transfer any and all cost or claim incur or file
          against Repeddle to User and shall step down for Users to take her
          place as agreeable between the Users and Repeddle in serving such
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          notifying us that you no longer wish to use the Services, or when you
          cease using our App and Website. Repeddle will not have any liability
          whatsoever to you for any suspension or termination. The obligations
          ...
          including ownership, success fees, warranty disclaimers, indemnity and
          limitations of liability. If in our sole judgment you fail, or we
          suspect that you have failed, to comply with any term or provision of
          these Terms of Use, we also may terminate this agreement at any time
          without notice and you will remain liable for all amounts due up to
          and including the date of termination; and/or accordingly may deny you
          access to our Services (or any part thereof). Furthermore, we may
          suspend or terminate the Services or Your account at Our discretion
          without explanation, notice, and liability to Repeddle including
          removing and discarding any items or content within the Service for
          any reason, in our capacity, we may strive to provide a timely
          explanation. Any suspected fraudulent, abusive or illegal activity
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          Millennials recreate, resell and buy secondhand fashion for the
          benefit of the planet and our environment, these users form part of
          Repeddle independent “third party partners.” Except stated otherwise,
          Repeddle is not a direct buyer nor seller of products sold by
          independent Sellers, we however facilitate transactions between buyers
          and sellers. Sellers agree to all rights necessary to sell the
          products they make available, and will describe such products
          truthfully, accurately, and completely. Buyers are solely responsible
          for reading and reviewing the entire products listing before making
          any offer or purchase. The contract to purchase is entirely between
          Buyer and Seller. In accordance to Consumer Protection Act, 68 of 2008
          (the “CPA”), Repeddle may help facilitate ELIGIBLE returns between
          Seller and Buyer and refund buyers after a successful return has been
          made to Seller. In some cases, Buyers may message Sellers directly
          through the Repeddle private message system with regard to their
          concerns for return and both party may reach a suitable agreement. In
          these instance, Repeddle does not take part in the return process but
          may help facilitate approved refund if need be. Please refer to our
          Return and Refund Policy to ensure all Terms are met. In the place
          where a buyer has message a seller about a return and there’s any
          contestation between both parties, Repeddle may interfere, or is
          authorize to attempt to resolve this to a satisfactory degree between
          both parties. However, Repeddle is not mandatorily or under any
          obligation to do so.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          posted by us on our App and Website or in respect to the service,
          ...
          prior versions of the Terms of Use. Any ambiguities in the
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          applicable to this Agreement. The General Terms of use and any
          separate agreements whereby we provide you services will be governed
          by and construed and enforced in accordance with the laws of Federal
          Republic of Nigeria.
        </p>
        <p className="text-justify mt-4">
          It is of Repeddle’s interest to amicably resolve disputes that may
          arise between users or the use of the service. Please use the
          respective contacts below to email support as applies within your
          jurisdiction. If the respective dispute resulting from General Terms
          or Agreement could not be settled by negotiations, then depending on
          the nature of the matter, the dispute will be finally solved by Lagos
          Multi Door Court House, if any provision of the General Terms is held
          to be unenforceable, the parties will substitute for the affected
          provision an enforceable provision that approximates the intent and
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          the following takes precedence with respect to South African Users:
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          update, change, modify, replace or discontinue any part of these Terms
          of Use by posting updates and changes to our App and Website. It is
          your responsibility to check our App or Website periodically for
          changes and we may, but not liable to notify you through email,
          messages or notifications on the App or Website and effect takes place
          upon publishing of the amendments. Your continued use, or access to
          our App and Website or the Service following the posting of any
