...
const BuyersProtection = () => {
  return (
    <div className="container mx-auto max-w-7xl px-8">
        ...
        className="text-orange-400 hover:text-malon-color hover:underline"> here.</Link> Any payment made outside our App or Website will not be covered by the buyer’s protection. 
        ...
        className="text-orange-400 hover:text-malon-color hover:underline"> here.</Link>
        </p>
        </section>
    </div>
  )
