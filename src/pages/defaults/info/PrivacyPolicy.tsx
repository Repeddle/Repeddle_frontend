    ...
    <div className="container mx-auto max-w-7xl px-8">
      ...
      <section className="mb-8">
        <div className="text-justify -mt-5">
          ...
          collected, used, and shared when you visit, use or make a purchase
          from repeddle (the “App or Website”). By using any part of our
          platforms, services, App or Website you are deemed to have read,
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          information about how you interact with the App or Website. We refer
        ...
        <p className="text-justify mt-5">
          ...
          Understand that you are obliged to provide us with accurate and
          correct information when registering, signing-up or making any
          purchase on our Site. This information includes but not limited to:
          Your full name “First and Surname”, Date of birth, Email address,
          Phone number, physical address/postal (delivery)address, Gender and
          correct card information. We will not be liable for any cancellation
          of order, miscommunication or wrong delivery due to your false or
          miss-information.
        </p>
      </section>
      <h1 className="font-medium text-xl mb-8 lg:text-2xl text-red-600">
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          Our company is a social e-commerce marketplace, this means we may use
          a lot of social media interactions and links such as Instagram,
          Facebook, TikTok, Twitter, Pintrest, LinkedIn, Youtube etc, to
          communicate with both our community and the general public. When you
          use any form of our platform, we may use any part of the content as
          deem fit for both marketing and communication purposes and the social
          media networks we use may collect any part of your information, or the
          information shared for its own purposes. This information may be
          collected through the links (both ours and theirs) that you might have
          shared on any of their platform. These services have its own privacy
          policies which are independent to the company. Please ensure to read
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          time the user returns to the same site, the browser retrieves this
          file and sends it to the website’s server.
        </p>
        <p className="text-justify mt-5">
          We can distinguish two types of cookies, which have different
          purposes: technical cookies and advertising cookies:
        </p>
        <p className="text-justify mt-5">
        ...
        <p className="text-justify mt-5">
          Advertising cookies may be created not only by the website on which
          the user is browsing, but also by other websites displaying
          advertisements, announcements, widgets or other elements on the page
          displayed. These cookies can be used to carry out targeted
          advertising, i.e. advertising determined according to the user’s
          navigation.
        </p>
        <p className="text-justify mt-5">
          We use technical cookies. These are stored in your browser for a
        ...
        <p className="text-justify mt-5">
          ...
          analysis tool that generates a cookie to measure the number of visits
          to the site, the number of pages viewed and visitor activity. Your IP
          address is also collected to determine the city from which you
          connect.
        </p>
        <p className="text-justify mt-5">
          We remind you that you can refuse the deposit of cookies by
          configuring your browser. However, such a refusal could prevent the
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          to delete your data from Repeddle App, you can remove your information
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          Protection of Personal Information Act, Act 4 of 2013 (“POPI”) The
          PAIA and POPIA Acts are available online at www.gov.za/documents/acts
          ...
          stores, and uses your information primarily for the following
          purposes: <br />
          To provide services to you as instructed and requested by you.
          <br />
          To authenticate your information as per clients’ requests.
          <br />
        ...
        <p className="text-justify mt-5">
          ...
          any or one of the services offered by us through any of our platform
          or communication channel, we may collect your personal information.
          The information we maintain concerning our clients is stored in
          databases (where that have built-in safeguards to ensure its privacy
          and confidentiality. Repeddle accepts no obligation or liability
          whatsoever for any loss, damage (whether direct, indirect, special, or
          consequential) and/or expenses of any nature whatsoever which may
          arise as a result of, or which may be attributed directly or
          indirectly from information made available on these pages or links, or
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          protection laws. Our hosting company will host our App and Website in
          a secure server environment that uses firewall and other advance 3D
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          by e‑mail at support@repeddle.com
        </p>
      </section>
    </div>
  );
