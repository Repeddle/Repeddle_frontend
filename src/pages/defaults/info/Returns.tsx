    ...
    <div className="container mx-auto max-w-7xl px-8">
      ...
      <section className="mb-8">
        <div className="-mt-5 text-justify">
          ...
          platform. However, we strongly encourage both Sellers and Buyers to
          take precaution when selling or buying in order to avoid what may lead
      ...
      <section className="mb-8">
        <p className="text-justify -mt-5">
          ...
          product, buyer must log a return or message seller through the Log a
          Return letting the seller know about the issue. The seller and buyer
          may reach a suitable agreement for both party to resolve the issue, if
          the buyer insist of returning eligible product, the buyer must request
      ...
      <section className="mb-8">
        <div className="text-justify -mt-5">
          ...
          <p className="pt-0">
            Should you not Log a Return on Repeddle App or Website within
            72hours (3 days) you received your delivery, payment will be
            automatically remitted to the seller. Immediately the seller has
            been paid, we are not obliged to dispute any sale or refund you.
          </p>
        </div>
      </section>
      <h2 className="font-medium text-xl text-center text-red-600 mb-8 lg:text-2xl">
